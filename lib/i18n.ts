...
export const translations = {
  es: {
    ...
    speakers: {
      ...
      viewAllSpeakers: 'Ver Todos los Ponentes',
      confirmed: 'Confirmado',
      pending: 'PENDIENTE',
      searchPlaceholder: 'Buscar por nombre, empresa o posición...',
      noResults: 'No se encontraron ponentes con ese criterio de búsqueda.',
      roles: {
    ...
    contact: {
      ...
      applyAsSponsor: 'Aplicar como Sponsor',
      applyAsSpeaker: 'Aplicar como Ponente',
      company: 'Empresa',
      companyPlaceholder: 'Nombre de la empresa',
      phone: 'Teléfono',
      phonePlaceholder: '+1 (xxx) xxx-xxxx',
      companyOrganization: 'Empresa / Organización',
      companyOrganizationPlaceholder: 'Tu empresa u organización',
      sponsorshipLevel: 'Nivel de Patrocinio de Interés',
      selectLevel: 'Selecciona un nivel',
      other: 'Otro',
      sponsorMessagePlaceholder: 'Cuéntanos sobre tu empresa y por qué te interesa patrocinar DBW 2026...',
      sendSponsorApplication: 'Enviar Solicitud de Patrocinio',
      sponsorApplicationReceived: 'Hemos recibido tu solicitud de patrocinio. Te contactaremos pronto.',
      speakerDescription: '¿Tienes una charla interesante sobre blockchain, Web3 o DeFi? Aplica para ser ponente en DBW 2026.',
      talkTopic: 'Tema de la Charla',
      talkTopicPlaceholder: 'Ej: DeFi en América Latina, Regulación de Criptoactivos...',
      bio: 'Biografía Breve',
      bioPlaceholder: 'Cuéntanos sobre tu experiencia y expertise...',
      previousSpeaking: 'Experiencia Previa como Ponente',
      previousSpeakingPlaceholder: 'Eventos anteriores donde has hablado, conferencias, etc.',
      speakerMessagePlaceholder: 'Cuéntanos más sobre tu propuesta de charla y por qué sería relevante para DBW 2026...',
      sendSpeakerApplication: 'Enviar Solicitud de Ponente',
      speakerApplicationReceived: 'Hemos recibido tu solicitud para ser ponente. Te contactaremos pronto.',
      topics: {
  ...
  en: {
    ...
    speakers: {
      ...
      noResults: 'No speakers found with that search criteria.',
      roles: {
        president: 'President',
        mayor: 'Mayor',
        consulGeneral: 'Consul General',
    ...
    contact: {
      ...
      applyAsSponsor: 'Apply as Sponsor',
      applyAsSpeaker: 'Apply as Speaker',
      company: 'Company',
      companyPlaceholder: 'Company name',
      phone: 'Phone',
      phonePlaceholder: '+1 (xxx) xxx-xxxx',
      companyOrganization: 'Company / Organization',
      companyOrganizationPlaceholder: 'Your company or organization',
      sponsorshipLevel: 'Sponsorship Level of Interest',
      selectLevel: 'Select a level',
      other: 'Other',
      sponsorMessagePlaceholder: 'Tell us about your company and why you\'re interested in sponsoring DBW 2026...',
      sendSponsorApplication: 'Send Sponsorship Application',
      sponsorApplicationReceived: 'We have received your sponsorship application. We will contact you soon.',
      speakerDescription: 'Do you have an interesting talk about blockchain, Web3 or DeFi? Apply to be a speaker at DBW 2026.',
      talkTopic: 'Talk Topic',
      talkTopicPlaceholder: 'E.g.: DeFi in Latin America, Crypto Asset Regulation...',
      bio: 'Brief Biography',
      bioPlaceholder: 'Tell us about your experience and expertise...',
      previousSpeaking: 'Previous Speaking Experience',
      previousSpeakingPlaceholder: 'Previous events where you have spoken, conferences, etc.',
      speakerMessagePlaceholder: 'Tell us more about your talk proposal and why it would be relevant for DBW 2026...',
      sendSpeakerApplication: 'Send Speaker Application',
      speakerApplicationReceived: 'We have received your speaker application. We will contact you soon.',
      topics: {
